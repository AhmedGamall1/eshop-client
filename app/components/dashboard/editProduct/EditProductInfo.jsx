...
const EditProductInfo = ({ setPage, productInfo, setProductInfo }) => {
  ...
  return (
    <div className="h-full py-4">
      <div className="w-[70%] m-auto h-full bg-white rounded-md relative  shadow-xl px-4 py-3">
        <div className="">
          ...
          >
            ...
            <div className="flex w-full items-center justify-between gap-4">
              ...
              <div className="w-[45%]">
                <label className="text-[#A0A5BA]">
                  Discount Price <span className="text-sm">[optional]</span>
                </label>
                <input
            ...
            <div className="flex w-full justify-end mt-5 bottom-5 right-6 absolute">
              <button
                type="submit"
