...
const EditProductContent = ({
  ...
  return (
    <div className="h-full py-4">
      <div className="w-[70%] relative m-auto h-full bg-white rounded-md overflow-y-auto  shadow-xl px-4 py-3">
        <div className="px-2 mt-3">
          ...
          <div className="w-full flex-between mt-4 absolute bottom-5 right-0 px-6">
            <button
              type="submit"
